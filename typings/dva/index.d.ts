...
declare module 'dva/router' {
  export { Link, Redirect, Route, Router, Switch } from 'react-router-dom';
  import * as routerRedux from 'react-router-redux';
  export { routerRedux };
}

// webpack.config.dev.js 中，resolve.alias.router = src/router.dev.tsx
// webpack.config.prod.js 中，resolve.alias.router = src/router.prod.tsx
declare module '@router' {
  export default class Router extends React.PureComponent<any, any> {}
}
